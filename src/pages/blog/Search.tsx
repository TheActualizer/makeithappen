...
const Search = () => {
  ...
  const searchBlogPosts = async (searchTerm: string): Promise<SearchResult[]> => {
    ...
    try {
      ...
      console.log('Raw blog posts response:', blogPosts);
      console.log(`Found ${blogPosts?.length || 0} blog posts`);

      if (blogPosts) {
        blogPosts.forEach(post => {
          console.log('Blog post match:', {
            id: post.id,
            title: post.title,
  ...
  const searchProjects = async (searchTerm: string): Promise<SearchResult[]> => {
    console.log('\n=== Searching Projects ===');
    console.log('Search term:', searchTerm);
  ...
  const searchDocuments = async (searchTerm: string): Promise<SearchResult[]> => {
    console.log('\n=== Searching Documents ===');
    console.log('Search term:', searchTerm);
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      console.log('Blog posts found:', blogResults.length);
      console.log('Projects found:', projectResults.length);
